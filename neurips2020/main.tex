...
\end{align}
Our derivation is general for any covariance matrix, so 
...
In the final layer the weight matrix we take the patch size to be same as the activation 

To summarise, the steps for computing 
